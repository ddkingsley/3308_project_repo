...
function get_mood() {
    ...
    if (answer.textContent == ringColors[0])
    {
        ...
        meaning.textContent = "You feel angry, fearful, or apathetic. You may be overworked or depressed.";
    }
    // Yellow
    ...
    if (answer.textContent == ringColors[4])
    {
        ...
        meaning.textContent = "Relaxed. Your emotions are stable today: you do not feel execessive negativity or positivity.";
    }
    // Blue
    if (answer.textContent == ringColors[5])
    {
        ...
        meaning.textContent = "Your mood is upbeat. You are in positive spirits and feel optimistic and amiable.";
    }
    // Dark Blue
    if (answer.textContent == ringColors[6])
    {
        ...
        meaning.textContent = "You are content. Your inner optimism has been fulfilled and you feel satisfied.";
    }
    // Violet
    ...
    if (answer.textContent == ringColors[8])
    {
        ...
        meaning.textContent = "You are overcome with strong emotions. You are infatuated with someone or curious about something.";
    }
}
